...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *key = [_keys objectAtIndex:indexPath.section];
    NSString *string = [[_cities objectForKey:key] objectAtIndex:indexPath.row];
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:string,@"city", nil];
    
//    NSNotification *notification = [[NSNotification alloc]initWithName:@"city" object:self userInfo:dic];
